...
class CasesControllerTest < ActionController::TestCase
  ...
  test "should create case" do
    assert_difference('Case.count') do
      post :create, case: { description: @case.description, sponsor: @case.sponsor, title: @case.title }
    end
  ...
  test "should update case" do
    patch :update, id: @case, case: { description: @case.description, sponsor: @case.sponsor, title: @case.title }
    assert_redirected_to case_path(assigns(:case))
  end
